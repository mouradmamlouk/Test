...
<title>Intégration API Twitter</title>
...
<div id="wrapper" class="hfeed">
    ...
    <header>
        <section class="contained">
            <a id="logo"  title="Cloud Computing" href="www.openshift.com">Cloud Computing</a>
        </section>
    </header>
...
<section id="content">
    <article id="post-988" class="post-988 page type-page status-publish hentry">
        <div class="entry-title">
            <h1><a href="chercher.php">Rechercher un TWEET</A></h1>
        </div>
